...
public class GetSolutionStackHandler : IRequestHandler<GetSolutionStack, SolutionStackResponse?>
{
    ...
    public async Task<SolutionStackResponse?> Handle(GetSolutionStack request, CancellationToken cancellationToken)
    {
