...
public class User : AuditableEntity
{
    ...
    public string Identifier { get; private init; } // Username or Email
    ...
    // Local Auth Fields (null for SSO users)
    public string? PasswordHash { get; private set; }
    public DateTime? PasswordChangedAt { get; private set; }
    public bool? RequirePasswordChange { get; private set; }

    // SSO Fields (null for local users)
    ...
    // Preferences (cached from external or local)
    public string? TimeZone { get; private set; }
    public string? Locale { get; private set; }
    public string? Preferences { get; private set; } // JSON for UI preferences
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        Dictionary<string, object>? claims = null)
    {
        ...
        var user = new User
        {
            ...
            AuthType = AuthenticationType.SingleSignOn,
            Status = UserStatus.Active,
            IsLocked = false
        };
